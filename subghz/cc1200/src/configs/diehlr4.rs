...
///     Carrier Frequency: 868.309937MHz (868.310MHz)
///     Symbol Rate: 101.5ksps (Diehl Sharky 775 uses 101,5ksps)
///     RX Filter BW: 208.333333kHz (200kHz)
///     Modulation Format: 2-FSK
///     Deviation: 25.405884kHz (25.375kHz)
...
///     SYNC1          0x54
///     SYNC0          0x3D
///     SYNC_CFG1      0xAB -> 0x5F  16 bit syncword and max threshold
...
pub const DHLR4: ConfigPatch<'static> = ConfigPatch {
    ...
    values: &[
        ...
        0x5F, // SYNC_CFG1             Sync Word Detection Configuration Reg. 1
        0x23, // SYNC_CFG0             Sync Word Detection Configuration Reg. 0
        0x4D, // DEVIATION_M           Frequency Deviation Configuration
        0x0B, // MODCFG_DEV_E          Modulation Format and Frequency Deviation Configur..
        ...
        0xC9, // SYMBOL_RATE1          Symbol Rate Configuration Mantissa [15:8]
        0x86, // SYMBOL_RATE0          Symbol Rate Configuration Mantissa [7:0]
        ...
        0xD4, // FREQ1                 Frequency Configuration [15:8]
        0xBC, // FREQ0                 Frequency Configuration [7:0]
